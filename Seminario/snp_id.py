...
try:
   ...
   file02 = sys.argv[2]
   print("Usuário forneceu o nome do arquivo da primeira sequência como: ", file02)
   ...
   #Lendo a segunda arquivo e salvando o ID e a sequência
   name02 = ""
   seq02 = ""
   FASTA02 = open(file02, "r")
   for line in FASTA02:
     line = line.rstrip()
     if line.startswith('>'):
       name02 = line
   ...
   if not set(seq01).issubset(set("ATCG")) or set(seq02).issubset(set("ATCG")):
